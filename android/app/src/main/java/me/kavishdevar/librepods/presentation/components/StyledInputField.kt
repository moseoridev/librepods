...
fun StyledInputField(
    ...
    style: InputFieldStyle = InputFieldStyle.Standard
) {
    when (style) {
        InputFieldStyle.Standard -> {
            TextField(
                state = inputState,
                placeholder = {
                    Text(
...
/** Presentation of the text field. [Legacy] retains the pre-migration custom renderer. */
